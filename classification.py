...
if __name__ == "__main__":
    ...
    for name in ["MultinomialNB", "BernoulliNB", "KNeighborsClassifier", "SVC"]:
        ...
        print("=============" * 5)
        classification = Classification(classifier=clf, X=features_tf, y=targets)
        classification.eval().report_metrics()
        print("=============" * 5)
        print("Feature - Inverse Document Frequency, Classifier - {}, Metrics:".format(name))
        print("=============" * 5)
        classification = Classification(classifier=clf, X=features_idf, y=targets)
        classification.eval().report_metrics()
        print("=============" * 5)
        print("Feature - TFIDF, Classifier - {}, Metrics:".format(name))
        print("=============" * 5)
        classification = Classification(classifier=clf, X=features_tf_idf, y=targets)
        classification.eval().report_metrics()
